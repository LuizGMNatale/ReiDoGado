...
public class produtoConsulta extends javax.swing.JFrame {
    ...
    public void setProduto(Produto produto) {
     ...
     public void pesquisar(){
        List<Produto> lista = ItensVendaDAO.buscarProduto(txtProdutoNome);
        ...
        if (lista != null && !lista.isEmpty())
        {
            ...
            for (int i = 0; i < lista.size(); i++) 
            {
                ...
                if (produto != null) 
                {
                    ...
                    dadosTabela[1] = produto.getNomeProd();
                    dadosTabela[2] = produto.getQuantidade();
                    dadosTabela[3] = produto.getValorVenda();
                    dadosTabela[4] = produto.getFaturacao();
